...
h2[2].style.cssText = `background-color:gray;color:black;border:2px solid blue;`

var add = document.querySelector('.add');
var del = document.querySelector('.del');
var h2 = document.querySelector('h2');//h2의 첫번쨰 것
...
//h4의 첫번쨰 태그를 클릭하면 h4전체스타일을 변경해라
